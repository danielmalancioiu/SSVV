...
public abstract class AbstractFileRepository<ID, E extends com.ssvv.repository.HasID<ID>> extends AbstractCrudRepository<ID, E> implements FileRepository<ID, E> {
